    ...
    return <>
        <main className={'container flex justify-center items-center mt-10 mb-10 flex-col space-y-20'}>
            <section className={'max-w-2xl relative text-center space-y-6'}>
                ...
                <div className={'absolute top-[80%] rotate-6 -z-10 blur-3xl rounded-3xl right-[40%] md:h-[600px] h-[300px] w-[100%] bg-gradient-to-r from-orange-300/30 to-rose-300/30'}></div>
            </section>
            <section>
                <div
